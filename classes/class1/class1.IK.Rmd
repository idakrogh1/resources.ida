...
knitr::opts_knit$set(root.dir = "/Users/idakrogh/Desktop/Methods 2/resources.ida")
...
```{r}
# Load data
hibbs <- read.table("/Users/idakrogh/Desktop/Methods 2/resources.ida/classes/data/ElectionsEconomy/data/hibbs.dat", header = TRUE)
getwd()
...
y_data <- y_line + rnorm(length(x), mean = 0, sd = sd)
...
library(tidyverse)
read_csv("~/Desktop/Methods 2/resources.ida/classes/data/Names/data/allnames_clean.csv")
